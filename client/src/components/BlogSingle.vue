          ...
          <article>
            ...
            <header class="mb-8">
              ...
              <div class="text-center md:text-left">
                <h1 class="h1 font-red-hat-display mb-4" :class="{ '-m-6': props.post.title.startsWith('《') }" data-aos="fade-down">
                  {{ props.post.title }}
                </h1>
              ...
              <div class="md:flex md:items-center md:justify-between mt-5">
                ...
                <div class="flex items-center justify-center" data-aos="fade-down" data-aos-delay="300">
                  ...
                  <div>
                    ...
                    <a class="font-medium text-gray-800 dark:text-gray-300 hover:underline" href="#0">
                      Binyu
                    </a>
