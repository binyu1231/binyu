      ...
      <div class="py-12 md:py-16 border-t border-gray-200 dark:border-gray-800 -mt-px">
        ...
        <div class="md:flex md:items-center md:justify-between">
          ...
          <ul class="flex mb-4 md:order-2 md:ml-4 md:mb-0">
            ...
            -->
            <li class="ml-4">
              <a class="flex justify-center items-center text-white bg-teal-500 dark:text-teal-500 dark:bg-gray-800 hover:underline hover:bg-teal-600 rounded-full transition duration-150 ease-in-out" href="https//github.com/114000" aria-label="Github">
                <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
