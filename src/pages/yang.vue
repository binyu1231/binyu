...
export default {
  mounted() {
    ...
    const baseTime = 1522080000000 // 2018-03-27
...
<style>
.mail-container {
  width: 100%; height: 260px; font-size: 20px;
  text-align: center;
  padding: 1em;
  ...
  #58a 0, #58a 37.5%, white 0, white 50%) 0 / 6em 6em;
}
#process {
  width: 360px; height: 30px; margin: 50px auto 50px;
  background-color: #58a; position: relative;
